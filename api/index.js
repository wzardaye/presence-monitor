...
const app = express();
// Vercel serverless functions are bundled differently. 
// process.cwd() is the most reliable way to point to your project root on Vercel.
...
// FIX: Added your images directory back so UI elements don't break
app.use('/images', express.static(path.join(ROOT_DIR, 'images')));

// Frontend Routes (Serving HTML)
app.get('/', (req, res) => {
  // Note: If you want to use frontend_fixed.html instead, change the filename below
